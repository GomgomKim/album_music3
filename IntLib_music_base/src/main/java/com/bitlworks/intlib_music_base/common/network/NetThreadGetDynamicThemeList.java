...
public class NetThreadGetDynamicThemeList extends Thread {
	private String LOG_TAG_NAVI = "<NetThreadGetDynamicThemeList.class>";
	private final Context context;
	private final Handler handler;
	private int coupleId;
	
	
	public NetThreadGetDynamicThemeList(Context c, Handler h, int coupleId) {
		Log.i(StaticValues.LOG_TAG, LOG_TAG_NAVI + " NetThreadGetDynamicThemeList()");
		this.context = c;
		this.handler = h;
	...
	public void run() {
		try{
			...
			sb.append(StaticValues.SERVICE_URL + "getDynamicThemeList.php"); 
