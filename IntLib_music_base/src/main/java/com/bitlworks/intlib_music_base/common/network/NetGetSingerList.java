...
public class NetGetSingerList extends Thread {
    private String LOG_TAG_NAVI = "<NetGetMobileMusic.class>";
    private int mobile_music_id;
    private final Handler mHandler;

    public NetGetSingerList( int id, Handler h) {
    ...
    public void run() {
        try{
            ...
            sb.append(StaticValues.SERVICE_URL + "GetSingerList.php");
            sb.append("?music_id=" + mobile_music_id);
