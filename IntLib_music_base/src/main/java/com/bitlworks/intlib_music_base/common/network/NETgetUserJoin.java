...
public class NETgetUserJoin extends Thread {
    ...
    public NETgetUserJoin(int id, String phone_number, Handler h) {
    ...
    public void run() {
        try{
            ...
            sb.append(StaticValues.SERVICE_URL + "getUserJoin.php");
            sb.append("?a=" + album_id);
