...
public class NetGetSongList extends Thread {
    ...
    public void run() {
        try{
            ...
            sb.append(StaticValues.SERVICE_URL + "GetSongList.php");
            sb.append("?disk_id=" + mobile_music_id);
