...
public class NetInsertComment extends Thread {
    ...
    public NetInsertComment(int id, int user_id, String user_name, String contents, Handler h) {
    ...
    public void run() {
        try{
            ...
            sb.append(StaticValues.SERVICE_URL + "insertComment.php");
            sb.append("?album_id=" + mobile_music_id);
            sb.append("&user_id=" + user_id);
            sb.append("&user_name=" +  URLEncoder.encode(user_name, "UTF-8"));
            sb.append("&contents=" +  URLEncoder.encode(comment_contents, "UTF-8"));
