...
/**
 * Created by 강혁 on 2016-07-29.
 */
/*
public class NETupdateRegid {
}
*/
...
public class NETupdateRegid extends Thread {
    ...
    public NETupdateRegid(int user_id, String user_uuid, String user_appver, String user_regid, Handler h) {
        Log.i(StaticValues.LOG_TAG, LOG_TAG_NAVI + " NetGetMobileMusic()");
        this.mHandler = h;
        //this.studioId = studioId;
        //this.mobile_music_id = id;
    ...
    public void run() {
        try{
            ...
            sb.append(StaticValues.SERVICE_URL + "updateRegid.php");
            sb.append("?i=" + user_id);
            sb.append("&u=" + URLEncoder.encode(user_uuid, "UTF-8"));
            sb.append("&a=" +  URLEncoder.encode(user_appver, "UTF-8"));
            sb.append("&r=" +  URLEncoder.encode(user_regid, "UTF-8"));
