 ...
 */
/*
public class NETGetNewInfoList {
}
*/
...
public class NETGetNewInfoList extends Thread {
    private String LOG_TAG_NAVI = "<NetGetMobileMusic.class>";
    private int mobile_music_id;
    private final Handler mHandler;

    public NETGetNewInfoList( int id, Handler h) {
    ...
    public void run() {
        try{
            ...
            sb.append(StaticValues.SERVICE_URL + "GetNewInfoList.php");
