...
public class NetGetPhotoList extends Thread {
    private String LOG_TAG_NAVI = "<NetGetMobileMusic.class>";
    private int disk_id;
    private int album_id;
    private final Handler mHandler;

    public NetGetPhotoList( int album_id, int disk_id, Handler h) {
    ...
    public void run() {
        try{
            ...
            sb.append(StaticValues.SERVICE_URL + "GetPhotoList.php");
            sb.append("?album_id=" + album_id+"&disk_id="+disk_id);
